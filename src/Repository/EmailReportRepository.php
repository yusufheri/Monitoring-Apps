...
class EmailReportRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(EmailReport $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(EmailReport $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return EmailReport[] Returns an array of EmailReport objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?EmailReport
    {
        return $this->createQueryBuilder('e')
            ->andWhere('e.exampleField = :val')
            ->setParameter('val', $value)
